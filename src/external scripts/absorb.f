!        PROGRAM absorb
!        
!        Test program: Uncomment this section if you want to 
!            test subroutines.
!
!
!        IMPLICIT NONE
!
!        real :: freq, temp, pres, wv, kabs, clw
!
!        freq = 23.8
!        temp = 300.
!        pres = 1000.
...
!        clw = 10.
!
!        CALL absorb_all(freq, temp, pres, wv, clw, kabs)
!        write(*,*) kabs
!
!
!        END PROGRAM absorb

      subroutine absorb_all(freqy, temp, pres, vapor_pres,clw,kabs_all) bind(C, name = "absorb_all")
...
C +++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
      ...
      real  kabs_H2O, kabs_O2, kabs_N2, kabs_clw, kabs_all
      real  freqy, rho, temp, pres, vapor_pres, clw
...
c     Compute the vapor density, rho [g/m^3]      
      ...
      call abs_H2O(temp, pres, rho, freqy, kabs_H2O) 
        !write(*,*) 'abs_H20', kabs_H2O     
      call abs_O2 (temp, pres, rho, freqy, kabs_O2)
        !write(*,*) 'abs_O2', kabs_O2 
      call abs_N2 (temp, pres, freqy, kabs_N2)
        !write(*,*) 'abs_N2', kabs_N2
      call absorb_clw(freqy, temp, clw, kabs_clw)
        !write(*,*) 'abs_clw', kabs_clw
...
!      Write(*,*) 'FREQ, eps, RE, WATER, kabs', FREQ, eps, RE, WATER, kabs_clw
      RETURN
      END
